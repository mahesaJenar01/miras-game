/**
 * CollectionButton.js - Button for opening the card collection
 * Extends BaseButton with collection-specific styling
 */
import BaseButton from './BaseButton.js';

export default class CollectionButton extends BaseButton {
  /**
   ...
   */
  constructor(x = 0, y = 0, width = 120, height = 50) {
    // Use a soft gradient color theme like the shop button
    super(x, y, width, height, "#FFB7B2", "#FFD1CC", "Collection");
  ...
  /**
   * Generate decorative elements for the collection button
  ...
  generateDecorations() {
    ...
    // Add heart decoration specific to collection button
    decorations.push({
      type: 'cards',
