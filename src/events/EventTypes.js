...
export const COLLECTIBLE_EVENTS = {
  // Lifecycle events
  COLLECTIBLE_GENERATED: 'collectible:generated',
  COLLECTIBLE_COLLECTED: 'collectible:collected',
  
  // Counter events
  COLLECTIBLE_COUNT_UPDATED: 'collectible:count_updated',
  
  // Special events
  COLLECTIBLE_MILESTONE_REACHED: 'collectible:milestone_reached',
  COLLECTIBLE_SPECIAL_FOUND: 'collectible:special_found'
};